...
public class MainController {
    ...
    public String showstudents(Map<String, Object> model, @RequestParam Integer classid) {
        ...
        List<Student> list = jdbcTemplate.query("SELECT * FROM student WHERE class_id=" + classid + "", new StudentRowMapper());
    ...
    public String showteachers(Map<String, Object> model, @RequestParam Integer classid) {
        ...
        List<Teacher> list = jdbcTemplate.query("SELECT s.* from teacher as s, teacher_subject as t where t.class_id=" + classid + " and s.id = t.teacher_id", new TeacherRowMapper());
        model.put("classid", classid);
        model.put("list", list);
    ...
    public String showSubjects(Map<String, Object> model, @RequestParam Integer classid) {
        ...
        List<Subject> list = jdbcTemplate.query("SELECT s.* from subject as s, teacher_subject as t  where t.class_id=" + classid + " and s.id = t.subject_id", new SubjectRowMapper());
